...
def main():
    ...
    # CNN - using channels_last format
    conv1 = Conv2D(32, kernel_size=(3, 3), activation='tanh', padding='same', data_format='channels_last')(input_cnn)
    pool1 = MaxPooling2D(pool_size = (2,2), data_format='channels_last')(conv1)
    conv2 = Conv2D(64, kernel_size=(3, 3), activation='tanh', padding='same', data_format='channels_last')(pool1)
    pool2 = MaxPooling2D(pool_size = (2,2), data_format='channels_last')(conv2)
    conv3 = Conv2D(128, kernel_size=(3, 3), activation='tanh', padding='same', data_format='channels_last')(pool2)
    pool3 = MaxPooling2D(pool_size = (2,2), data_format='channels_last')(conv3)
    conv4 = Conv2D(256, kernel_size=(3, 3), activation='tanh', padding='same', data_format='channels_last')(pool3)
    pool4 = MaxPooling2D(pool_size = (2,2), data_format='channels_last')(conv4)
    conv5 = Conv2D(256, kernel_size=(3, 3), activation='tanh', padding='same', data_format='channels_last')(pool4)
    pool5 = MaxPooling2D(pool_size = (2,2), data_format='channels_last')(conv5)
    conv6 = Conv2D(512, kernel_size=(3, 3),activation='relu', padding='same', data_format='channels_last')(pool5)
    conv7 = Conv2D(512, kernel_size=(3, 3),activation='relu', padding='same', data_format='channels_last')(conv6)
